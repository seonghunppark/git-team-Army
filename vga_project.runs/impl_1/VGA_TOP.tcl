...
namespace eval ::optrace {
  variable script "D:/workspace/vga_project/vga_project.runs/impl_1/VGA_TOP.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet D:/workspace/vga_project/vga_project.runs/synth_1/VGA_TOP.dcp
